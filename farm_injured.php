...
$query_GetInjuryList = "select Name, Number, Injury, CON, PosC,	PosLW, PosRW, PosD, 'False' as PosG from players where Injury <> '' AND Status0<2 UNION ALL SELECT Name, Number, Injury, CON, 'False' as PosC,	'False' as PosLW, 'False' as PosRW, 'False' as PosD, 'True' as PosG from goalies where Injury <> '' AND Status1<2 ORDER BY CON asc";
} else {
$query_GetInjuryList = "select Name, Number, Injury, CON, PosC,	PosLW, PosRW, PosD, 'False' as PosG from players where Injury <> '' AND Status0<2 AND Team='".$_SESSION['current_Team_ID']."'  UNION ALL SELECT Name, Number, Injury, CON, 'False' as PosC,	'False' as PosLW, 'False' as PosRW, 'False' as PosD, 'True' as PosG from goalies where Injury <> '' AND Status1<2 AND Team='".$_SESSION['current_Team_ID']."' ORDER BY CON asc";
}
