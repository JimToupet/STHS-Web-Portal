...
$query_GetSeasonsStats= sprintf("SELECT * FROM proteamstandings as P, seasons as S, proteam as T WHERE T.Number=P.Number AND S.S_ID = P.Season_ID AND S.S_ID=%s ORDER BY P.Point desc, P.W desc", $SID_GetSeasonsStats);
...
<article>
    ...
    <section>
    <form action="pro_league_stats_history.php" method="post" name="form1">
	<?php
		...
		<br />
  		...
  		<div id="tabs">
            <div id="tabs-1">
				...
				do { ?>
                <tr>
                    <td align="center"><a href="pro_stats.php?team=<?php echo $row_GetSeasonsStats['Number'];?>&season_id=<?php echo $row_GetSeasonsStats['Season_ID'];?>"><?php echo $row_GetSeasonsStats['City']." ".$row_GetSeasonsStats['Name']; ?></a></td>
