...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = "UPDATE proteam SET CommishNotes='".$_POST['CommishNotes']."' WHERE Number='".$_POST['team']."'";
  
   
  $Result1 = mysql_query($updateSQL, $connection) or die(mysql_error());
	
	  $updateGoTo = "bio.php?team=".$_SESSION['current_Team_ID'];
  header(sprintf("Location: %s", $updateGoTo));
}

$query_EditGM = sprintf("SELECT proteam.CommishNotes FROM proteam WHERE proteam.Number=".$_GET['team']);
...
<title>Edit Commissioners G.M. Notes - <?php echo $_SESSION['SiteName'] ; ?></title>
...
<article>
    ...
    <section>
    <h1>Edit Commissioners G.M. Notes</h1>
    <br />
	<?php 
		...
		<?php
				...
				echo "<h1>Sorry</h1><p>You must log in to edit the GM notes.</p>";
			}
		} else {
			echo "<h1>Sorry</h1><p>You must log in to edit the GM notes.</p>";
		}
