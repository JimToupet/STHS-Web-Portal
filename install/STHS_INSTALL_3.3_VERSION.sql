...
CREATE TABLE `config` (
  ...
  `AI_UFA_BASE` int(2) NOT NULL DEFAULT '50',
  `AI_RFA_BASE` int(2) NOT NULL DEFAULT '70',
  `AI_PAY_CUT_90` int(2) NOT NULL DEFAULT '10',
  `AI_PAY_CUT_80` int(2) NOT NULL DEFAULT '20',
  `AI_PAY_CUT_70` int(2) NOT NULL DEFAULT '30',
  `AI_PAY_CUT_60` int(2) NOT NULL DEFAULT '40',
  `AI_PAY_CUT_50` int(2) NOT NULL DEFAULT '50',
  `AI_PAY_RAISE_10` int(2) NOT NULL DEFAULT '5',
  `AI_PAY_RAISE_20` int(2) NOT NULL DEFAULT '10',
  `AI_PAY_RAISE_30` int(2) NOT NULL DEFAULT '15',
  `AI_PAY_RAISE_40` int(2) NOT NULL DEFAULT '20',
  `AI_PAY_RAISE_50` int(2) NOT NULL DEFAULT '25',
  `AI_SIGNING_BONUS` int(2) NOT NULL DEFAULT '5',
  `AI_NO_TRADE` int(2) NOT NULL DEFAULT '5',
  `AI_MORALE_HIGH` int(2) NOT NULL DEFAULT '5',
  `AI_MORALE_LOW` int(2) NOT NULL DEFAULT '5',
  `AI_LOW_EXPECTATIONS` int(2) NOT NULL DEFAULT '10',
  `AI_DEPTH_CHARTS` int(2) NOT NULL DEFAULT '5',
  `AI_FAIL` int(2) NOT NULL DEFAULT '10',
  `AI_RFA_TO_UFA` int(2) NOT NULL DEFAULT '5',
  `AI_SEASON_PRE` int(2) NOT NULL DEFAULT '0',
  `AI_SEASON_REG_1ST` int(2) NOT NULL DEFAULT '5',
  `AI_SEASON_REG_2ND` int(2) NOT NULL DEFAULT '10',
  `AI_SEASON_POST` int(2) NOT NULL DEFAULT '15',
  `AI_WAIVE_NT` int(2) NOT NULL DEFAULT '10',
  `AI_FA_1ST_ODDS` int(2) NOT NULL DEFAULT '60',
  `AI_FA_2ND_ODDS` int(2) NOT NULL DEFAULT '30',
...
CREATE TABLE `farmteamstandings` (
  `T_ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `playerschangerequest` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(32) DEFAULT NULL,
  `Request` text,
...
CREATE TABLE `playerscontractoffers` (
...
CREATE TABLE `playersextensionoffers` (
  `PR_ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `teamhistory` (
  ...
  `Value` text,
  `DateCreated` datetime NOT NULL,
  `Viewed` varchar(5) NOT NULL DEFAULT 'False',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `todaysgame` (
...
CREATE TABLE `traderequests` (
  ...
  `RequestType` varchar(36) DEFAULT 'Extension',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `waiver_draftpicks` (
  `D_ID` int(11) NOT NULL AUTO_INCREMENT,
