...
case 'en': 
	...
	$l_ProCareerStats = "Farmz League Career Stats";
...
$query_GetSeasonsStats= sprintf("SELECT * FROM farmteamstandings as P, seasons as S WHERE S.S_ID = P.Season_ID AND S.SeasonType = %s AND P.Number = %s ORDER BY S.Season Asc", $SID_GetSeasonsStats, $_SESSION['current_Team_ID']);
...
<article>
    ...
    <section>
    <form action="farm_stats_history.php" method="post" name="form1">
