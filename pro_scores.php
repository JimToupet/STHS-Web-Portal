...
if($totalRows_GetLink > 0){
	...
	$query_GetLink = sprintf("SELECT * FROM todaysgame WHERE Season_ID=%s AND Type='Pro'ORDER BY Link DESC limit 0,1", $_SESSION['current_SeasonID']);
	$GetLink = mysql_query($query_GetLink, $connection) or die(mysql_error());
	$row_GetLink = mysql_fetch_assoc($GetLink);
...
<tbody>
<tr>
	<td width="25" style="vertical-align:middle;"><a href="pro_roster.php?team=<?php echo $row_GetHomeTeam['Number']; ?>"><img border="0" src="<?php echo $_SESSION['DomainName']; ?>/image/logos/small/<?php echo $row_GetHomeTeam['LogoTiny']; ?>" /></a></td>
	<td width="100" style="vertical-align:middle;"><a href="pro_roster.php?team=<?php echo $row_GetHomeTeam['Number']; ?>"><?php echo $row_GetHomeTeam['City']; ?></a></td>
...
<tr>
    ...
    <td style="vertical-align:middle;"><a href="roster.php?team=<?php echo $row_GetVisitorTeam['Number']; ?>"><?php echo $row_GetVisitorTeam['City']; ?></a></td>
