...
do { 
	...
	if($tmpRow == 2){
		...
		$tmpTeamSigned3 = $row_GetStatus['PR_ID'];
...
if ($totalRows_GetStatus == 3){
	...
	$tmpTeamRow = 1;
	$Winner = $row_GetStatus['City']." ".$row_GetStatus['TeamName'];
	$WinnerSalary = $row_GetStatus['Salary1'] + $row_GetStatus['Salary2'] + $row_GetStatus['Salary3'] + $row_GetStatus['Salary4'] + $row_GetStatus['Salary5'] + $row_GetStatus['Salary6'] + $row_GetStatus['Salary7'] + $row_GetStatus['Salary8'] + $row_GetStatus['Salary9'] + $row_GetStatus['Salary10'] + $row_GetStatus['bonus'];
	$WinnerContract = $row_GetStatus['Contract'];
	if ($row_GetStatus['NoTrade'] == 0){
		$tmpNoTradeDescription1 = "";
	} else {
		$tmpNoTradeDescription1 = $NoTrade;
...
$url = $_SESSION['DomainName'].'/ufa-free-agents_signed.php';
