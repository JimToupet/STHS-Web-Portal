...
if ((isset($_POST["MM_edit"])) && ($_POST["MM_edit"] == "form")) {
	...
	$insertSQL = sprintf("UPDATE playerscontractoffers set FarmPro=%s,Contract=%s,Salary1=%s,Salary2=%s,Salary3=%s,Salary4=%s,Salary5=%s,Salary6=%s,Salary7=%s,Salary8=%s,Salary9=%s,Salary10=%s WHERE PR_ID=%s",
...
$query_GetCoach = sprintf("SELECT * FROM coaches WHERE Name='%s'", $PID_GetPlayer);
...
<INPUT id="player" type="hidden" value="<?php echo $row_GetCoach['Name']; ?>" name=player>
...
<tr>
	<td width="110" valign="top" style="vertical-align:top">
    	<img src="<?php echo  imageExists("/image/coaches/".$row_GetCoach['Photo']); ?>" style=" border-color:#<?php echo $_SESSION['current_PrimaryColor']; ?>; width:100px; height:150px; border-width:1px; margin-top:10px; border-style:solid;" width="100" height="150"/>
	...
	<select id="tocoach" size=1 name=profarm><option value="Pro">Pro</option><option value="Farm">Farm</option><?php echo $row_GetContract['FarmPro'];?>
	</select>
        </div>
        <div class="rowElem">
