...
switch ($lang){ 
case 'en': 
	$l_MailSubject = "Warning - Over the Team 2 European Limit";
	$l_MailMessage  = "This message is to warn you that your hockey team is over the league 2 European player limit.  Please fix problem within the next 48 hours.  You can release or trade away players.  If you do not, you could face league fines.";
	break; 

case 'fr': 
	$l_MailSubject = "Avertissement - au-dessus de la limite d&apos;Europ&eacute;en de l&apos;&eacute;quipe 2";
	$l_MailMessage  = "Ce message est de vous avertir que votre &eacute;quipe de hockey est au-dessus de la limite de joueur d&apos;Europ&eacute;en de la ligue 2. Veuillez fixer le probl&egrave;me dans les 48 heures suivantes. Vous pouvez lib&eacute;rer ou commercer les joueurs partis. Si vous ne faites pas, vous pourriez faire face &agrave; des fines de ligue.";
	break;
} 
