...
<article>
    ...
    <br /><br clear="all" />
        ...
        <ul>
              ...
              <li id="selected"><a href="ufa-free-agents_w_offer.php"><?php echo $l_tab2; ?></a></li>
              <li><a href="ufa-free-agents_decide.php"><?php echo $l_tab3; ?></a></li>
            ...
            <table  cellspacing="0" border="0" width="100%" class="tablesorter">
					...
					<?php 
						...
						do { ;
							...
							//if($totalRows_GetStatus > $tmpCount){
								//echo ", ";
							//}
							if (isset($_SESSION['U_ID']) && $_SESSION['U_ID']==$row_GetStatus['Team']){
						...
						if(isset($_SESSION['U_Admin']) && $contractAccepted==1 && $_SESSION['U_Admin']==1){
							echo " = " . $tmpCount;
                        } 
                        ...
                        if(isset($_SESSION['U_ID']) && $contractAccepted==0 && $_SESSION['U_ID'] <> ""){
							...
							if ($tmp_PlacedBid == 0 && $contractAccepted==0){
								echo '<a href="offerSheet.php?player='.$row_GetSkaters['Number'].'&type=player">'.$l_Send.'</a>';
							} else {
                ...
                <?php
                  ...
                  <tr id="FreeAgent_<?php echo $rowCount;?>">
                    ...
                    <td style="text-align:center; min-width:100px;" valign="top">
					<?php 
                        $TeamOfferList = "0";
						$tmp_PR_ID=0;
						$tmpCount=0;
						...
						if($contractAccepted==0 && $_SESSION['U_ID'] <> ""){
							...
							if ($tmp_PlacedBid == 0 && $contractAccepted==0){
								echo '<a href="offerSheet.php?player='.$row_GetGoalies['Number'].'&type=goalie">'.$l_Send.'</a>';
							} else {
								echo $row_GetStatus['City'].' <a href="edit_offerSheet.php?player='.$row_GetGoalies['Number'].'&id='.$tmp_PR_ID.'&target=1&type=goalie">'.$l_Edit.'</a> | <a href="remove_offer_sheet.php?player='.$row_GetGoalies['Number'].'&id='.$tmp_PR_ID.'&type=goalie">'.$l_Remove.'</a>';
							}
						}
                        ?>
                    </td>
