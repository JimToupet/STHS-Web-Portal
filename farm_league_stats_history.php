...
if (isset($_SESSION['current_SeasonID'])) {
  $SID_GetSeasonsStats= (get_magic_quotes_gpc()) ? $_SESSION['current_SeasonID'] : addslashes($_SESSION['current_SeasonID']);
}
...
$query_GetSeasonsStats= sprintf("SELECT * FROM farmteamstandings as P, seasons as S, farmteam as T WHERE T.Number=P.Number AND S.S_ID = P.Season_ID AND S.S_ID=%s ORDER BY P.Point desc, P.W desc", $SID_GetSeasonsStats);
...
<title><?php echo $l_full_league_stats ." - ".$_SESSION['SiteName'] ; ?></title>
...
<article>
    ...
    <section>
    <form action="farm_league_stats_history.php" method="post" name="form1">
	<?php
	if ($row_GetSeasonsStats['SeasonType'] == 2){
	$SeasonType = $l_preseason;
	} else if ($row_GetSeasonsStats['SeasonType'] == 1){
	$SeasonType = $l_regularseason;
	} else if ($row_GetSeasonsStats['SeasonType'] == 0){
	$SeasonType = $l_playoffs;
	} 
	?>
	<div style="float:left; padding-bottom:2px"><h1><?php echo $l_full_league_stats." : "." ".$row_GetSeasonsStats['Season']." ".$SeasonType; ?></h1></div>
		...
		<div style="float:right; padding-top:5px;">
            ...
            ?>
            <option value="<?php echo $row_GetSeasonsLink['S_ID']; ?>" <?php if ($SID_GetSeasonsStats == $row_GetSeasonsLink['S_ID']){ echo "selected"; } ?>>
			<?php 
			if ($row_GetSeasonsLink['SeasonType'] == 2){
		...
		<br />
  		...
  		<div id="tabs">
            <div id="tabs-1">
				...
				do { ?>
                <tr>
                    <td align="center"><a href="farm_stats.php?team=<?php echo $row_GetSeasonsStats['Number'];?>&season_id=<?php echo $row_GetSeasonsStats['Season_ID'];?>"><?php echo  $row_GetSeasonsStats['City']." ".$row_GetSeasonsStats['Name']; ?></a></td>
                ...
                <tr>		
                    ...
                    <td align="center" ><?php echo number_format($tmpPowerRanking / $totalRows_GetSeasonsStats, 0); ?></td>	
            ...
            <div id="tabs-2">
                ...
                <?php while ($row_GetSeasonsStats= mysql_fetch_assoc($GetSeasonsStats)){ ?>
                <tr>
                    <td align="center"><a href="farm_stats.php?team=<?php echo $row_GetSeasonsStats['Number'];?>&season_id=<?php echo $row_GetSeasonsStats['Season_ID'];?>"><?php echo $row_GetSeasonsStats['Name']; ?></a></td>
                    <td align="center"><?php echo $row_GetSeasonsStats['GP']; $tmpGP=$tmpGP+$row_GetSeasonsStats['GP'];?></td>
            ...
            <div id="tabs-3">
                ...
                <tr>
                    ...
                    <th><a title="<?php echo $l_PCOF_OF;?>"><?php echo $l_PCOF;?></a></th>
