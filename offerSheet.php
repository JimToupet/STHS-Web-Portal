...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
	if($_POST["position"] == 5){
		$offerType="Goalie Offer Sheet";
	} else {
		$offerType="Offer Sheet";
	}
	
	$insertSQL = sprintf("INSERT INTO playerscontractoffers (Player,Type,Team,DateCreated,Contract,Salary1,Salary2,Salary3,Salary4,Salary5,Salary6,Salary7,Salary8,Salary9,Salary10,NoTrade,Bonus,NoTradeSalary,ContractType,Approved) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,'False')",
