...
$tmpSalary9 = 0;
$tmpSalary10 = 0;
for ( $counter = 1; $counter <= $_POST['yearsoff']; $counter += 1) {
	if($counter==1){ $tmpSalary1 = $_POST['newsal'];};
	if($counter==2){ $tmpSalary2 = $_POST['newsal'];};
	if($counter==3){ $tmpSalary3 = $_POST['newsal'];};
	if($counter==4){ $tmpSalary4 = $_POST['newsal'];};
	if($counter==5){ $tmpSalary5 = $_POST['newsal'];};
	if($counter==6){ $tmpSalary6 = $_POST['newsal'];};
	if($counter==7){ $tmpSalary7 = $_POST['newsal'];};
	if($counter==8){ $tmpSalary8 = $_POST['newsal'];};
	if($counter==9){ $tmpSalary9 = $_POST['newsal'];};
	if($counter==10){ $tmpSalary10 = $_POST['newsal'];};		
}

	$tmpNoTradeSalary = 0;
	if($_POST['notrade'] == 1){$tmpNoTradeSalary = $_POST['newsal'];}
	
	$insertSQL = sprintf("UPDATE playerscontractoffers set Contract=%s,Salary1=%s,Salary2=%s,Salary3=%s,Salary4=%s,Salary5=%s,Salary6=%s,Salary7=%s,Salary8=%s,Salary9=%s,Salary10=%s, NoTrade=%s, NoTradeSalary=%s, Compensation=%s WHERE PR_ID=%s",
...
$query_GetWebInfo = sprintf("SELECT MaxContract, ContractVary, MinimumPlayerSalary, MaximumPlayerSalary FROM config");
...
if ($Contract_Step == "final" && $row_GetContract['Salary'] > $row_GetWebInfo['MinimumPlayerSalary']){
	$MinimumPlayerSalary=$row_GetContract['Salary'];
}
...
<tr>
	<td width="110" valign="top" style="vertical-align:top">
     ...
     <?php } ?>
        ...
        <tbody>
          <tr>
            <td align="center"><div id="Year1">$<?php echo number_format($row_GetContract['Salary1'],0); ?></div></td>
            <td align="center"><div id="Year2">$<?php echo number_format($row_GetContract['Salary2'],0); ?></div></td>
            <td align="center"><div id="Year3">$<?php echo number_format($row_GetContract['Salary3'],0); ?></div></td>
            <td align="center"><div id="Year4">$<?php echo number_format($row_GetContract['Salary4'],0); ?></div></td>
            <td align="center"><div id="Year5">$<?php echo number_format($row_GetContract['Salary5'],0); ?></div></td>
            <td align="center"><div id="Year6">$<?php echo number_format($row_GetContract['Salary6'],0); ?></div></td>
            <td align="center"><div id="Year7">$<?php echo number_format($row_GetContract['Salary7'],0); ?></div></td>
            <td align="center"><div id="Year8">$<?php echo number_format($row_GetContract['Salary8'],0); ?></div></td>
            <td align="center"><div id="Year9">$<?php echo number_format($row_GetContract['Salary9'],0); ?></div></td>
            <td align="center"><div id="Year10">$<?php echo number_format($row_GetContract['Salary10'],0); ?></div></td>
        </tr>
        </tbody>
        </table>
        <div class="rowElem">
		...
		for ( $counter = 1; $counter <= $row_GetWebInfo['MaxContract']; $counter += 1) {
			if($counter == $row_GetContract['Contract']){
        ...
        <INPUT id="newsal" onfocus=select() size="8" maxlength="8" value="<?php echo ($row_GetContract['Salary1']+$row_GetContract['Salary2']+$row_GetContract['Salary3']+$row_GetContract['Salary4']+$row_GetContract['Salary5']+$row_GetContract['Salary6']+$row_GetContract['Salary7']+$row_GetContract['Salary8']+$row_GetContract['Salary9']+$row_GetContract['Salary10'])/$row_GetContract['Contract']; ?>" name=newsal ONCHANGE="FrontEnd();" >
		</div>
        
        <div class="rowElem" style="">
        <label><?php echo $l_SalaryDistribution;?>:</label>
        <select id="distribute" size=1  name="distribute" ONCHANGE="FrontEnd();"><option value="0"   <?php if($row_GetContract['Salary1']==$row_GetContract['Salary2']){ echo 'selected'; }?>>EVEN</option><option value="1"  <?php if($row_GetContract['Salary1']!=$row_GetContract['Salary2']){ echo 'selected'; }?>>FRONT-LOAD</option></select>
        ...
        <div class="rowElem" style="">
        <label>NO TRADE CLAUSE:</label>
        <select id="notrade" size=1  name="notrade"><option value="0" <?php if($row_GetContract['NoTrade']=="0"){ echo 'selected'; }?>><?php echo $l_False;?></option><option value="1" <?php if($row_GetContract['NoTrade']=="1"){ echo 'selected'; }?>><?php echo $l_True;?></option></select>
  ...
  <?php 
	if ($Contract_Step == "final"){
		echo  '<input type="hidden" name="MM_Contract_Step" value="final">';
	} else {
		echo  '<input type="hidden" name="MM_Contract_Step" value="0">';
	}
	?>
  <input type="hidden" name="id" value="<?php echo $Contract_ID; ?>">
  <input type="hidden" name="MM_edit" value="form">
  <input type="hidden" name="YearSalary1" value="<?php echo $row_GetContract['Salary1'];?>">
  <input type="hidden" name="YearSalary2" value="<?php echo $row_GetContract['Salary2'];?>">
  <input type="hidden" name="YearSalary3" value="<?php echo $row_GetContract['Salary3'];?>">
  <input type="hidden" name="YearSalary4" value="<?php echo $row_GetContract['Salary4'];?>">
  <input type="hidden" name="YearSalary5" value="<?php echo $row_GetContract['Salary5'];?>">
  <input type="hidden" name="YearSalary6" value="<?php echo $row_GetContract['Salary6'];?>">
  <input type="hidden" name="YearSalary7" value="<?php echo $row_GetContract['Salary7'];?>">
  <input type="hidden" name="YearSalary8" value="<?php echo $row_GetContract['Salary8'];?>">
  <input type="hidden" name="YearSalary9" value="<?php echo $row_GetContract['Salary9'];?>">
  <input type="hidden" name="YearSalary10" value="<?php echo $row_GetContract['Salary10'];?>">
  <input type="hidden" name="Compensation" value="<?php echo $row_GetContract['Compensation'];?>">
</form>
	</section>
</article>
