...
$query_GetSkaters = sprintf("SELECT * FROM players WHERE Team=%s AND Status0=3 AND Retired=0 ORDER BY Overall desc", $_SESSION['current_Team_ID']);
...
$query_GetScratched = sprintf("SELECT * FROM players WHERE Team=%s AND Status0=2 AND Retired=0 ORDER BY Overall desc", $_SESSION['current_Team_ID']);
...
$query_GetGoalies = sprintf("SELECT * FROM goalies WHERE Team=%s AND Status1=3  AND Retired=0 ORDER BY Overall desc", $_SESSION['current_Team_ID']);
...
$query_GetGScratched = sprintf("SELECT * FROM goalies WHERE Team=%s AND Status1=2  AND Retired=0 ORDER BY Overall desc", $_SESSION['current_Team_ID']);
...
$query_GetLeaders = sprintf("SELECT Captain, Assistant1, Assistant2 FROM proteamstandings WHERE Number=%s AND Season_ID=%s", $_SESSION['current_Team_ID'],$SID_GetTop5);
$GetLeaders = mysql_query($query_GetLeaders, $connection) or die(mysql_error());
$row_GetLeaders = mysql_fetch_assoc($GetLeaders);

$query_GetCoach = sprintf("SELECT * FROM coaches WHERE Team='%s' AND coaches.FarmPro='Pro'", $_SESSION['current_Team'] );
...
<title><?php echo $l_nav_roster;?> - <?php echo $_SESSION['SiteName'] ; ?></title>
