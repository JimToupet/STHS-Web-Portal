...
$query_GetSkaters = sprintf("SELECT players.* FROM players WHERE (players.AvailableforTrade = 'True' or players.AvailableforTrade = 'Vrai') AND players.Retired=0 ORDER BY Overall desc");
...
$query_GetGoalies = sprintf("SELECT goalies.* FROM goalies WHERE (goalies.AvailableforTrade = 'True' or goalies.AvailableforTrade = 'Vrai') AND goalies.Retired=0 ORDER BY Overall desc");
...
<title><?php echo $l_nav_trading_block;?> - <?php echo $_SESSION['SiteName'] ; ?></title>
...
<article>
    ...
    <section>
    <h1><?php echo $l_nav_trading_block;?></h1>
