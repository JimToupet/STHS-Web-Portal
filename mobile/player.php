...
<div id="content">
	...
	<ul class="pageitem">
        ...
        <li class="menu"><span class="name"><?php echo $l_CK_D." : ".$row_GetPlayer['CK'];?></span></li>        
        <li class="menu"><span class="name"><?php echo $l_FG_D." : ".$row_GetPlayer['FG'];?></span></li>        
        <li class="menu"><span class="name"><?php echo $l_DI_D." : ".$row_GetPlayer['DI'];?></span></li>        
        <li class="menu"><span class="name"><?php echo $l_SK_D." : ".$row_GetPlayer['SK'];?></span></li>        
        <li class="menu"><span class="name"><?php echo $l_ST_D." : ".$row_GetPlayer['ST'];?></span></li>        
        ...
        <li class="menu"><span class="name"><?php echo $l_PH_D." : ".$row_GetPlayer['PH'];?></span></li>        
        <li class="menu"><span class="name"><?php echo $l_FO_D." : ".$row_GetPlayer['FO'];?></span></li>        
        <li class="menu"><span class="name"><?php echo $l_PA_D." : ".$row_GetPlayer['PA'];?></span></li>        
        <li class="menu"><span class="name"><?php echo $l_SC_D." : ".$row_GetPlayer['SC'];?></span></li>        
        <li class="menu"><span class="name"><?php echo $l_DF_D." : ".$row_GetPlayer['DF'];?></span></li>        
