...
if ((isset($_POST["MM_edit"])) && ($_POST["MM_edit"] == "form")) {
	...
	$insertSQL = sprintf("UPDATE playerscontractoffers set Contract=%s,Salary1=%s,Salary2=%s,Salary3=%s,Salary4=%s,Salary5=%s,Salary6=%s,Salary7=%s,Salary8=%s,Salary9=%s,Salary10=%s, NoTrade=%s, Bonus=%s, NoTradeSalary=%s, ContractType=%s WHERE PR_ID=%s",
...
$query_GetPlayerExtensionOffersTeams = sprintf("SELECT Team FROM playersextensionoffers WHERE Player=%s GROUP BY Team ", $PID_GetPlayer);
...
if(checkPlayersFuture($_SESSION['U_ID'], $row_GetPlayer['Position'], $row_GetPlayer['Overall'], $connection) == 1){
...
var AVERAGEOFFER = <?php echo $row_GetAvgSalary['Salary'];?>;
