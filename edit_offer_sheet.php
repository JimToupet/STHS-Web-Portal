...
if ((isset($_POST["MM_edit"])) && ($_POST["MM_edit"] == "form")) {
	...
	$insertSQL = sprintf("UPDATE playerscontractoffers set Contract=%s,Salary1=%s,Salary2=%s,Salary3=%s,Salary4=%s,Salary5=%s,Salary6=%s,Salary7=%s,Salary8=%s,Salary9=%s,Salary10=%s, NoTrade=%s, NoTradeSalary=%s WHERE PR_ID=%s",
...
function FrontEnd() {
	...
	document.form.YearSalary1.value=0;
...
<tr>
	<td width="110" valign="top" style="vertical-align:top">
     ...
     <?php } ?>
        ...
        <div class="rowElem"><label></label><input type="submit" value="<?php echo $l_SendOffer;?>" class="button edit"></div>
